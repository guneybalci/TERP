 ...
 */
!(function (a) {
  "function" == typeof define && define.amd ? define(["./picker", "jquery"], a) : "object" == typeof exports ? (module.exports = a(require("https://mophy.dexignzone.com/xhtml/error-404.html"), require("jquery"))) : a(Picker, jQuery);
})(function (a, b) {
  function c(a, b) {
    var c = this,
      d = a.$node[0],
  ...
  (c.prototype.set = function (a, b, c) {
    ...
    (c.prototype.createRange = function (a, c) {
      ...
      return (
        e.isInteger(a) || (a = f(a)), e.isInteger(c) || (c = f(c)), e.isInteger(a) && b.isPlainObject(c) ? (a = [c.year, c.month, c.date + a]) : e.isInteger(c) && b.isPlainObject(a) && (c = [a.year, a.month, a.date + c]), { from: f(a), to: f(c) }
      );
    }),
    ...
    (c.prototype.validate = function (a, c, d) {
      ...
      if ((!d || (!d.nav && !d.defaultValue)) && ((!m && j.disabled(c)) || (m && j.disabled(c) && (p || f || g)) || (!m && (c.pick <= n.pick || c.pick >= o.pick))))
        for (
          ...
          c.pick <= n.pick ? ((h = !0), (l = 1), (c = j.create([n.year, n.month, n.date + (c.pick === n.pick ? 0 : -1)]))) : c.pick >= o.pick && ((i = !0), (l = -1), (c = j.create([o.year, o.month, o.date + (c.pick === o.pick ? 0 : 1)]))),
          !h || !i);
                      ...
                      item: function (a) {
                        ...
                        return [
                          e.node(
                            ...
                            (function (b) {
                              return (
                                b.push(j.month == a.month ? c.klass.infocus : c.klass.outfocus), g.pick == a.pick && b.push(c.klass.now), d && b.push(c.klass.selected), f && b.push(c.klass.highlighted), n && b.push(c.klass.disabled), b.join(" ")
                              );
                            })([c.klass.day]),
    ...
    (c.defaults = (function (a) {
      return {
        ...
        labelMonthSelect: "Bir ay seç",
        labelYearSelect: "Select a year",
        monthsFull: ["Ocak", "Şubat", "Mart", "Nisan", "Mayıs", "Haziran", "Temmuz", "Ağustos", "Eylül", "Ekim", "Kasım", "Aralık"],
        monthsShort: ["Oca", "Şub", "Mar", "Nis", "May", "Haz", "Tem", "Ağu", "Eyl", "Eki", "Kas", "Ara"],
        weekdaysFull: ["Pazar", "Pazartesi", "Salı", "Çarşamba", "Perşembe", "Cuma", "Cumartes"],
