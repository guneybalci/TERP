...
(function (h) {
  ...
  n.defaults = {
    ...
    oClasses: {},
    oLanguage: {
      oAria: { sSortAscending: ": artan sütunu sıralamak için etkinleştir", sSortDescending: ": sütunu azalan sıralamak için etkinleştir" },
      oPaginate: { sFirst: "İlk", sLast: "Son", sNext: "İleri", sPrevious: "Geri" },
      sEmptyTable: "No data available in table",
      sInfo: "_TOTAL_ girişten _START_ - _END_ arasındakiler gösteriliyor",
      sInfoEmpty: "0 kayıttan 0 ile 0 arası gösteriliyor",
      sInfoFiltered: "(_MAX_ toplam girişten filtrelendi)",
      sInfoPostFix: "",
      sDecimal: "",
      sThousands: ",",
      sLengthMenu: "_MENU_ girdi kayıtları listeleniyor",
