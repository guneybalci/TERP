            ...
            s = function (t) {
                ...
                return r.__extends(e, t), e.prototype.updateDayTable = function () {
                    ...
                    var n = this,
                        ...
                        o = n.getDayClasses(t);
                    return o.unshift("fc-day", r.calendar.theme.getClass("widgetContent")), '<td class="' + o.join(" ") + '"' + (i ? ' data-date="' + t.format("DD-MM-YYYY") + '"' : "") + (e ? " " + e : "") + "></td>"
